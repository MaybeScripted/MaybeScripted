...
def svg_overwrite(filename, star_data, repo_data, contrib_data, loc_data):
    """
    Parse SVG files and update elements with my age, stars, repositories, and lines written
    """
...
if __name__ == '__main__':
    ...
    # Age calculation removed for privacy
    ...
    svg_overwrite('dark_mode.svg', star_data, repo_data, contrib_data, total_loc[:-1])
    svg_overwrite('light_mode.svg', star_data, repo_data, contrib_data, total_loc[:-1])

    # move cursor to override 'Calculation times:' with 'Total function time:' and the total function time, then move cursor back
    print('\033[F\033[F\033[F\033[F\033[F\033[F',
        '{:<21}'.format('Total function time:'), '{:>11}'.format('%.4f' % (user_time + loc_time + star_time + repo_time + contrib_time)),
